...
public class User extends Model {
     ...
     * @param  unhashedPassword password
     * @return hashed version of password
     */
    public static String hashPassword(String unhashedPassword){
        return Whirlpool.hashPassword(unhashedPassword);
    }
    ...
    public static class Whirlpool {
        ...
        /**
         * The core models.User.Whirlpool transform.
         */
        ...
        /**
         * Generate the NESSIE test vector set for models.User.Whirlpool.
         *
        ...
        {
            Whirlpool w = new Whirlpool();
            byte[] digest = new byte[DIGESTBYTES]; //This should change so that it's not stock
        ...
        /**
         * Generate the ISO/IEC 10118-3 test vector set for models.User.Whirlpool.
         */
